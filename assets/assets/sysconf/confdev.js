...
$(document).on("change", ".setAccess", function () {
    ...
    $.ajax({
      type: "POST",
      url: baseUrl+"sysconf/sysfunction/setAccess",
      data: {role_id:$(this).attr('data-role'),function_id:$(this).attr('data-func'),type:type},
      cache: false,
