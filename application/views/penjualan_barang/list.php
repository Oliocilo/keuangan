   ...
   <div class="card page-header p-0">
    ...
    <div class="page-body">
        <div class="card">
            <div class="card-header filterCard">
                <div class="row m-b-10 b-b-primary p-b-10 ">
                    ...
                    <div class="col-md-3 d-flex align-items-center justify-content-end">
                        <button onclick="addForm()" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah Penjualan"><i class="fa fa-plus-square"></i> Tambah Penjualan</button>
                        <?php if(false){?>
            ...
            <div class="card-body cardbodytbale">
                ...
                <table id="example" class="table custom-table table-hover table-bordered thead-center dataTable table-responsive d-lg-table" width="100%">
    ...
    <table class="table" style="margin-bottom :0px;">
        <tr>
            <td style="width: 100%;padding: 0px;">
                <button onclick="addForm()" class="btn btn-sm btn-block btn-success" data-toggle="tooltip" data-placement="top" title="Tambah Penjualan"><i class="fa fa-plus-square"></i>Tambah Penjualan</button>
            </td>
        </tr>
    </table>
</div>
