 ...
 <div class="j-wrapper j-wrapper-640">
     <form class="j-pro" novalidate="" id="formajax" action="<?= base_url('utangpiutang/store/'.$type) ?>" autocomplete="off">
        <div class="j-content">
            ...
            <div class="j-unit">
                <div class="checkbox-fade fade-in-primary mt-0">
                    <label>
                        <input type="checkbox" name="jatuh_tempo" data-toggle="collapse" href="#collapseTempo" aria-expanded="true" aria-controls="collapseTempo">
                        <span class="cr"><i class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
                        <span class="text-inverse">Jatuh Tempo</span>
                    </label>
                </div>
            </div>
            <div class="j-row panel-collapse collapse in" id="collapseTempo" role="tabpanel" aria-labelledby="headingTempo">
                <div class="j-span7 j-unit">
                    ...
                    <div class="j-input">
                        ...
                        <input type="text" class="date_from" name="tanggal_tempo">
                    </div>
                </div>
                <div class="j-span5 j-unit">
                    ...
                    <div class="j-input" >
                        ...
                        <input type="text" class="jam" name="jam_tempo">
                    </div>
                </div>
            </div>
            <div class="j-unit">
            ...
            <div class="j-unit">
                ...
                <div class="input">
                    <input type="hidden" name="tipe" value="<?=$type == 'Utang' ? 1 : 2?>">
            ...
            <div class="j-unit">
                <div class="checkbox-fade fade-in-primary mt-0">
                    <label>
                        <input type="checkbox" name="catat" data-toggle="collapse" href="#collapseCatat" aria-expanded="true" aria-controls="collapseCatat">
                        <span class="cr"><i class="cr-icon icofont icofont-ui-check txt-primary"></i></span>
