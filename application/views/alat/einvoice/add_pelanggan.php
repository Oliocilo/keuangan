 ...
 <div class="j-wrapper j-wrapper-640">
     <form class="j-pro" novalidate="" action="<?= base_url('alat/einvoice/storePelanggan/') ?>" id="formajax" autocomplete="off">
        <div class="j-content">
             <div class="j-unit">
            ...
            <div class="j-unit">
                ...
                <div class="input">
                    <input type="text" name="alamat_1">
                </div>
            </div>
            <div class="j-unit">
                <label class="j-label">Alamat Baris 2</label>
                <div class="input">
                    <input type="text" name="alamat_2">
                </div>
            </div>
            <div class="j-unit">
                <label class="j-label">Alamat Baris 3</label>
                <div class="input">
                    <input type="text" name="alamat_3">
                </div>
            </div>
