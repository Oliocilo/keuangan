 ...
 <div class="j-wrapper j-wrapper-640">
     <form class="j-pro" novalidate="" id="formajax" action="<?= base_url('master/barang/update') ?>" autocomplete="off">
            ...
            <div class="j-row">
                <div class="j-span7 j-unit">
                    ...
                    <div class="j-input">
                        ...
                        <input type="text" class="date_from" name="tanggal" readonly=""  value="<?=date('Y-m-d',strtotime($dataEdit['tanggal']))?>">
                    </div>
                </div>
                <div class="j-span5 j-unit">
                    ...
                    <div class="j-input" >
                        ...
                        <input type="text" class="jam" name="jam" value="<?=date('H:i',strtotime($dataEdit['tanggal']))?>">
                    </div>
                </div>
            </div>
            <div class="j-unit">
                ...
                <div class="input">
                    <input type="text" name="kode_barang" value="<?=$dataEdit['kode_barang']?>">
                </div>
            </div>
            <div class="j-unit">
                <label class="j-label">Nama Barang <small class="text-danger">*</small></label>
                <div class="input">
                    <input type="text" name="nama_barang" value="<?=$dataEdit['nama_barang']?>">
                </div>
            </div>
        </div>
        <div class="j-footer">
