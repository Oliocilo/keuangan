<form action="<?=base_url('conf/rekening/store')?>" id="formajaxaw">
		...
		<div class="form-group">
			...
			<div style="border: 1px solid #ddd;text-align: center;">
				...
				<img src="<?=base_url('assets/images/file-upload-icon.jpg')?>" alt="Preview" id="previewImage" style="width: 140px;" onclick="uploadFile()">
				</label>
			</div>
		</div>
